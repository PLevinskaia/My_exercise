slovar1={'global':None} #имя пространства:имя родителя
slovar2={'global':[]} #имя пространства:имя переменной

def create(namesp,parent):
    slovar1[namesp]=parent
    slovar2[namesp]=[]
    #print('\n',slovar1)
    #print(slovar2, '\n')

def add(namesp,argum):
    if namesp in slovar2.keys():
        slovar2[namesp].append(argum)
    #print('\n',slovar1)
    #print(slovar2, '\n')

def get(namesp,argum):
    if namesp is None or namesp not in slovar1.keys():
        return print(None)
    if namesp in slovar2.keys() and argum in slovar2[namesp]:
        print(namesp)
    else:
        get((slovar1[namesp]), argum)
